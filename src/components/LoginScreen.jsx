export default function LoginScreen () {
    return (
        <>
            ...
            <div className="relative z-50 w-screen h-screen bg-yellow-300">
                <div className="absolute inset-x-0 top-0 h-1/8 bg-yellow-400 border-black border-2"> 
                ...
                <div className="absolute inset-x-0 bottom-0 h-1/8 bg-yellow-400 border-black border-2"> 
